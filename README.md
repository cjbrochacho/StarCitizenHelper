...
**Latest release: v2026.09.17.3.** See [all releases](https://github.com/cjbrochacho/StarCitizenHelper/tags)
for the full history; each one is a tagged commit, so `git checkout v2026.09.17.3` always gets you
